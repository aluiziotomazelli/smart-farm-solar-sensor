...
TEST_F(DayNightControllerTest, ShouldEnterNightModeSyncedTriggersLateAtNight)
{
    ...
    EXPECT_FALSE(sut_->should_enter_night_mode(0, true, 23, 0, 81));
    EXPECT_FALSE(sut_->should_enter_night_mode(0, true, 23, 0, 81));
    EXPECT_TRUE(sut_->should_enter_night_mode(0, true, 23, 0, 81));
}
...
TEST_F(DayNightControllerTest, ShouldEnterNightModeSyncedTriggersEarlyMorningBeforeSunrise)
{
    ...
    EXPECT_FALSE(sut_->should_enter_night_mode(0, true, 4, 0, 81));
    EXPECT_FALSE(sut_->should_enter_night_mode(0, true, 4, 0, 81));
    EXPECT_TRUE(sut_->should_enter_night_mode(0, true, 4, 0, 81));
}
